...
public class Pedido extends AbstractAggregateRoot<Pedido>{
	...
	@JsonIgnore
	@Embedded // essa propriedade ela é um tipo incoporado. Esta classe é uma parte da entidade restaurante.
	...
	//metodo de callback - executado em alguns eventos das entidades
	@PrePersist
