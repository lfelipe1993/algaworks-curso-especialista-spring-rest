...
import br.net.digitalzone.algafood.domain.exception.PedidoNaoEncontradoException;
...
public class EmissaoPedidoService {
	...
	private void validarPedido(Pedido pedido) {
		...
		if(restaurante.naoAceitaFormaDePagamento(formaPagamento)) {
			...
			String.format("Forma de pagamento '%s' não é aceita nesse restaurante", formaPagamento.getDescricao()));
		}
	}
