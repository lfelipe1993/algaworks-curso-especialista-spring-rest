...
public class AlgaSecurity {
	...
	public Authentication getAuthentication() {
		// obtendo um objeto authentication que representa o token que ta autenticando a
		// req atual.
	...
	//se pelo menos uma authoriry tiver o nome passado como parametro retorna true.
