...
public interface UsuarioControllerOpenApi {
	...
	UsuarioDTO salvar(@ApiParam(name = "corpo", value = "Representação de um novo usuário", required = true) UsuarioComSenhaInput usuarioInput);
    ...
    @ApiOperation(value = "Remove usuario",hidden = true)
	...
	void atualizarSenha(@ApiParam(value = "ID do usuário", example = "1", required = true) Long usuarioId, 
