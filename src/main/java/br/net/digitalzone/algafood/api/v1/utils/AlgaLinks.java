package br.net.digitalzone.algafood.api.v1.utils;
...
import br.net.digitalzone.algafood.api.v1.controller.EstatisticasController;
import br.net.digitalzone.algafood.api.v1.controller.FluxoPedidoController;
...
import br.net.digitalzone.algafood.api.v1.controller.PermissaoController;
import br.net.digitalzone.algafood.api.v1.controller.RestauranteController;
import br.net.digitalzone.algafood.api.v1.controller.RestauranteFormaPagamentoController;
...
import br.net.digitalzone.algafood.api.v1.controller.RestauranteUsuarioController;
import br.net.digitalzone.algafood.api.v1.controller.UsuarioController;
import br.net.digitalzone.algafood.api.v1.controller.UsuarioGrupoController;
...
public class AlgaLinks {
	...
	public Link linkToPedidos(String rel) {
		...
		return new Link(UriTemplate.of(WebMvcLinkBuilder.linkTo(PedidoController.class).toUri().toString(),
	...
	public Link linkToResponsaveisRestaurante(Long restauranteId, String rel) {
		return WebMvcLinkBuilder
				.linkTo(WebMvcLinkBuilder.methodOn(RestauranteUsuarioController.class).listar(restauranteId))
				.withRel(rel);
	}
	...
	public Link linkToFormaPagamento(Long formaPagamentoId, String rel) {
		return WebMvcLinkBuilder
				.linkTo(WebMvcLinkBuilder.methodOn(FormaPagamentoController.class).buscar(null, formaPagamentoId))
				.withRel(rel);
	}
	...
	public Link linkToCozinha(Long cozinhaId, String rel) {
		return WebMvcLinkBuilder.linkTo(WebMvcLinkBuilder.methodOn(CozinhaController.class).buscarCozinha(cozinhaId))
				.withRel(rel);
	}
	...
	public Link linkToRestauranteResponsaveisDessacociacao(Long restauranteId, Long formaPagamentoId, String rel) {
	...
	public Link linkToRestauranteResponsaveisAssociacao(Long restauranteId, String rel) {
		return WebMvcLinkBuilder
				.linkTo(WebMvcLinkBuilder.methodOn(RestauranteUsuarioController.class).associar(restauranteId, null))
				.withRel(rel);
	}
	...
	public Link linkToRestauranteFormasPagamentoDessacociacao(Long restauranteId, Long formaPagamentoId, String rel) {
	...
	public Link linkToProdutos(Long restauranteId, String rel) {
		return WebMvcLinkBuilder
				.linkTo(WebMvcLinkBuilder.methodOn(RestauranteProdutoController.class).buscar(restauranteId, null))
				.withRel(rel);
	}
