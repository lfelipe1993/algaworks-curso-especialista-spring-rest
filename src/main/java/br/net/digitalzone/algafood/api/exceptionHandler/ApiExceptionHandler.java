...
import br.net.digitalzone.algafood.domain.exception.ValidacaoException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	private ResponseEntity<Object> handleInvalidFormat(InvalidFormatException ex, HttpHeaders headers,
		...
		// Reduzo para uma string concatenando cada resultado com .
	...
	protected ResponseEntity<Object> handleNoHandlerFoundException(NoHandlerFoundException ex, HttpHeaders headers,
		...
		String detail = String.format("O recurso '%s' não existe. Corrija ou remova esse recurso e tente novamente.",
				ex.getRequestURL());
...
//				.status(status.value())
//				.type("https://algafood.com.br/entidade-nao-encontra")
...
//				.build();
	...
	public ResponseEntity<?> AcessoNegado(AccessDeniedException ex, WebRequest request) {
		...
		Problem problem = createProblemBuilder(status, problemType, detail)
				.userMessage("Você não possui permissão para executar esta ação").build();
	...
	public ResponseEntity<?> handleValidacaoException(ValidacaoException ex, WebRequest request) {
		HttpStatus status = HttpStatus.BAD_REQUEST;
		return handleValidationInternal(ex, new HttpHeaders(), status, request, ex.getBindingResult());
